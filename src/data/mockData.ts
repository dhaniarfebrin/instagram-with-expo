...
export const mockUsers: User[] = [
  ...
  },
  {
    ...
    avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc4a33e80?w=200&h=200&fit=crop',
    isVerified: false,
  },
  {
    id: '4',
...
export const mockPosts: Post[] = [
  {
    ...
    caption: 'Amazing sunset view from the mountains! 🏔️ The beauty of nature never ceases to amaze me. #travel #nature #mountains',
    likes: 12453,
  ...
  },
  {
    ...
    caption: 'Homemade pizza night! 🍕 Nothing beats a fresh Margherita pizza made from scratch. Who else loves pizza?',
    likes: 8921,
  ...
  },
  {
    id: '3',
    user: mockUsers[2],
    image: 'https://images.unsplash.com/photo-1518173946687-a4c036bc5c78?w=800&h=800&fit=crop',
    caption: 'Morning walk in the forest 🌲 Nature is therapy. Take time to appreciate the little things.',
    likes: 15678,
  ...
  },
  {
    id: '4',
    user: mockUsers[3],
    image: 'https://images.unsplash.com/photo-1480714378408-67cf0d27bc1b?w=800&h=800&fit=crop',
    caption: 'City lights never get old 🌃 Night vibes in downtown. This city has so much life! #city #night #urban',
    likes: 22345,
